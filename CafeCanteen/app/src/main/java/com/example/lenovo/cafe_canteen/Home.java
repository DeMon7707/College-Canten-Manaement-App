...
import com.example.lenovo.cafe_canteen.Model.Category;
import com.example.lenovo.cafe_canteen.Service.ListenOrder;
import com.example.lenovo.cafe_canteen.viewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent walletIntent = new Intent(Home.this,Wallet.class);
